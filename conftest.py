...
def filler():
    ...
    generated by the test function.

    This object is properly constructed in the pytest_runtest_call() hook.
    """
...
def pytest_runtest_call(item):
    ...
    if "filler" not in item.funcargs:
        pytest.fail(
            "Invalid test function signature: Test did not use "
            " filler parameter to pass the fixture filler callback."
        )

    def filler(test_spec):

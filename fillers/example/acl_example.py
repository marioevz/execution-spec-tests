...
from ethereum_test_tools import AccessList, Account, Environment, Filler
...
def test_access_list(filler: Filler, fork: Fork):
    """
    ...
    filler(StateTest(env=env, pre=pre, post=post, txs=[tx]))
